...
class TCPServerSample
{
	...
	public static void Main (string[] args)
	{
		...
		while (true)
		{
			...
			//we now process every client that has data available
			...
			//Although technically not required, now that we are no longer blocking, it is good to cut your CPU some slack
			Thread.Sleep(100);
		}
	}
}
